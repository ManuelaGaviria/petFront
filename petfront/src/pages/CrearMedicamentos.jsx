...
function CrearMedicamentos() {
    const { nombre, descripcion, dosis, changeNombre, changeDescripcion, changeDosis } = useContext(GeneralContext)
    ...
    async function CrearMedicamentos() {
        if (nombre === "" || descripcion === "" || dosis === "") {
            ...
            const respuesta = await fetchBody('/medicamentos/agregar', 'POST', data);
            ...
            <div className='principal-container'>
                <Contenedor animate={true}>
                    ...
                    <div>
                        ...
                        <LabelInput texto="Descripción" eventoCambio={changeDescripcion}></LabelInput>
                        <LabelInput texto="Dosis" eventoCambio={changeDosis}></LabelInput>
                        <Button clase="ButtonNav" eventoClick={CrearMedicamentos}>Crear</Button>
...
export default CrearMedicamentos